...
export default function Resume() {
    ...
    return (
        <Text style={styles.text as StyleProp<TextStyle>}>
            ...
            <h2>Experience</h2>
            <h3>Columbia Sportswear Company ◦ Senior Software Engineer ◦ August 2021 to June 2025</h3>
            <ResumeList
                data={[
            ...
            />
            <h3>Avinode ◦ Software Engineer ◦ August 2018 to March 2021</h3>
            <ResumeList
                data={[
            ...
            />
            <h3>Graphic Products ◦ Web Developer ◦ October 2017 to August 2018</h3>
            <ResumeList
                data={[
                    "Built and maintained React and C# .NET MVC web pages for a flight operations application, focusing on user experience and functionality.",
                    "Developed and optimized SQL scripts for database management including stored procedures and indexes.",
            ...
            />
            <h3>Convoyant ◦ Software Engineer ◦ May 2014 to June 2017</h3>
            <ResumeList
                data={[
            ...
            />
            <h2>Projects at Columbia Sportswear</h2>
            <h3>Salesforce Order Management (SFOM) - August 2024 to June 2025</h3>
            <ResumeList
                data={[
            ...
            />
            <h3>AWS Lambda Node Upgrades - January 2024 to June 2024</h3>
            <ResumeList
                data={[
            ...
            />
            <h3>Education</h3>
            Portland State University • B.S. in Computer Science - Portland, OR - 3.3 GPA
        </Text>
    );
}
